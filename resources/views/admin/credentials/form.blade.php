        ...
        <div class="space-y-6 lg:col-span-2">
            <x-admin.card>
                <div class="space-y-4">
                    ...
                    <x-admin.bilingual name="organization" label="Organisation" :record="$record"/>
                    <x-admin.bilingual name="location" label="Location" :record="$record"/>
            ...
            <x-admin.card>
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-3">
                        <x-admin.input name="start_year" type="number" label="From" :value="$record?->start_year"/>
                        <x-admin.input name="end_year" type="number" label="To" :value="$record?->end_year"/>
                    </div>
            ...
            <x-admin.card>
                <div class="space-y-3">
                    <x-admin.toggle name="is_current" :label="__('site.present')" :value="$record?->is_current ?? false"
                                    hint="Shows “Present” instead of an end year."/>
